...
<div className="group relative w-full max-w-[756px] min-h-[250px] p-[24px] rounded-[16px] border border-[#E5E5E5] flex items-center justify-center overflow-hidden transition-all duration-500 ease-in-out">
...
<div className="group relative w-full max-w-[756px] min-h-[250px] p-[24px]  gap-[24px] rounded-[16px] border border-[#E5E5E5] flex items-center justify-center overflow-hidden transition-all duration-500 ease-in-out">
