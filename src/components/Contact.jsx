...
<div className="group relative w-full max-w-[756px] min-h-[250px] p-[24px] rounded-[16px] border border-[#E5E5E5] flex items-center justify-center overflow-hidden transition-all duration-500 ease-in-out hover:bg-[#FAFAF5] hover:cursor-pointer">
  ...
  <div className="absolute inset-0 flex flex-col items-center text-center gap-[10px] top-[24px] transition-all duration-500 ease-in-out 
    ...
    <p className="font-tt font-regular text-[15px] text-gray-600 leading-[120%] max-w-[303px]">
      78 Church Road Barnes, London SW13 9DN
    </p>

    <div className="flex gap-[24px] justify-center">
      <p className="font-tt font-regular text-[15px] text-gray-600">0777 281 5515</p>
      <p className="font-tt font-regular text-[15px] text-gray-600">0208 879 3682</p>
    </div>
  </div>
  ...
  <div className="absolute inset-0 flex flex-col items-center text-center gap-[16px] top-[24px] transition-all duration-500 ease-in-out 
    ...
    <div className="w-full max-w-[304px] flex justify-between gap-2 text-[15px] text-[#474747]">
      <div className="text-left space-y-1">
        <h2 className="font-tt font-regular">Mon - Thurs</h2>
        <h2 className="font-tt font-regular">Fri - Sun</h2>
      </div>
      <div className="text-right space-y-1">
        <h2 className="font-tt font-regular">08:00 - 18:00</h2>
        <h2 className="font-tt font-regular">08:00 - 19:00</h2>
      </div>
    </div>
  </div>
