 ...
 const dropdownItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 4, title: 'SPECIAl', description: 'Advanced analytics and Limited-time bThis session is different to a usual 1:1. It is an opportunity to become familiar with the studio, the apparatus and discuss your goals with a teacher. Perfect if you are new to Pilates, the studio or if you have an injury.enefits for new users..', price: '04' },
        { id: 5, title: 'INTERMEDIATE', description: 'Professional Limited-time bThis session is different to a usual 1:1. It is an opportunity to become familiar with the studio, the apparatus and discuss your goals with a teacher. Perfect if you are new to Pilates, the studio or if you have an injury.enefits for new users. and access.', price: '05' },
        { id: 6, title: 'Master', description: 'Professional Limited-time bThis session is different to a usual 1:1. It is an opportunity to become familiar with the studio, the apparatus and discuss your goals with a teacher. Perfect if you are new to Pilates, the studio or if you have an injury.enefits for new users. and access.', price: '06' },
      ]
    }
  ];
  return (
