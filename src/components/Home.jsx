 ...
 const dropdownItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 4, title: 'SPECIALIST', description: 'Advanced analytics and Limited-time bThis session is different to a usual 1:1. It is an opportunity to become familiar with the studio, the apparatus and discuss your goals with a teacher. Perfect if you are new to Pilates, the studio or if you have an injury.enefits for new users..', price: '04' },
