...
const Home = () => {
 ...
 const dropdownItems = [
    ...
    },
    {
      title: 'Levels',
      items: [
        { id: 1, title: 'foundation', description: 'This session is different to a usual 1:1. It is an opportunity to become familiar with the studio, the apparatus and discuss your goals with a teacher. Perfect if you are new to Pilates, the studio or if you have an injury.', price: '01' },
        { id: 2, title: 'INTERMEDIATE', description: 'This session is different to a usual 1:1. It is an opportunity to become familiar with the studio, the apparatus and discuss your goals with a teacher. Perfect if you are new to Pilates, the studio or if you have an injury.', price: '03' },
        { id: 3, title: 'SPECIALIST', description: 'This session is different to a usual 1:1. It is an opportunity to become familiar with the studio, the apparatus and discuss your goals with a teacher. Perfect if you are new to Pilates, the studio or if you have an injury.', price: '06' },
        { id: 4, title: 'Special', description: 'This session is different to a usual 1:1. It is an opportunity to become familiar with the studio, the apparatus and discuss your goals with a teacher. Perfect if you are new to Pilates, the studio or if you have an injury.', price: '09' },
        { id: 5, title: 'INTERMEDIATE', description: 'This session is different to a usual 1:1. It is an opportunity to become familiar with the studio, the apparatus and discuss your goals with a teacher. Perfect if you are new to Pilates, the studio or if you have an injury.', price: '12' },
        { id: 6, title: 'Master', description: 'This session is different to a usual 1:1. It is an opportunity to become familiar with the studio, the apparatus and discuss your goals with a teacher. Perfect if you are new to Pilates, the studio or if you have an injury.', price: '15' },
      ]
    }
  ];
  return (
