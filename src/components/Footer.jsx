...
const Footer = () => {
  return (
    <footer className="relative w-full max-w-[1920px] min-h-[644px] gap-[96px] pt-[96px] pr-[192px] pb-[24px] pl-[192px] border-t flex flex-col items-center justify-center mx-auto">
      {/* Background image */}
